...
<html>
  ...
  <div class="mod_songlist">
	...
	<c:forEach items="${message }" var="str">
		...
		<a href="<c:url value='/UserCollectionServlet?method=collection&songname=${str.songname}&singername=${str.singername }&username=${username }'/>"><img class="play" src="music/images/plus49.png"/></a>
